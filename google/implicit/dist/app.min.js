...
{
	if (region.U.z === region.ad.z)
	{
		return 'on line ' + region.U.z;
	}
	return 'on lines ' + region.U.z + ' through ' + region.ad.z;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.an, request.J, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aj: fragment, aU: host, a2: path, a3: port_, a4: protocol, F: query};
	});
...
var $author$project$OAuth$Implicit$AuthorizationSuccess = F5(
	function (token, refreshToken, expiresIn, scope, state) {
		return {aR: expiresIn, a6: refreshToken, S: scope, V: state, be: token};
	});
...
var $author$project$OAuth$Implicit$parseTokenWith = F2(
	function (_v0, url_) {
		...
		var url = _Utils_update(
			url_,
			{aj: $elm$core$Maybe$Nothing, a2: '/', F: url_.aj});
		var _v1 = A2(
			$elm$url$Url$Parser$parse,
			A2(
...
var $author$project$Main$init = F3(
	function (mflags, origin, navigationKey) {
		var redirectUri = _Utils_update(
			origin,
			{aj: $elm$core$Maybe$Nothing, F: $elm$core$Maybe$Nothing});
		var clearUrl = A2(
		...
		switch (_v0.$) {
			case 0:
				return _Utils_Tuple2(
					{e: $author$project$Main$Idle, av: redirectUri},
...
var $author$project$Main$defaultHttpsUrl = {aj: $elm$core$Maybe$Nothing, aU: '', a2: '', a3: $elm$core$Maybe$Nothing, a4: 1, F: $elm$core$Maybe$Nothing};
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$configuration = {
	K: _Utils_update(
		$author$project$Main$defaultHttpsUrl,
		{aU: 'accounts.google.com', a2: '/o/oauth2/v2/auth'}),
	...
	Z: _Utils_update(
		$author$project$Main$defaultHttpsUrl,
		{aU: 'www.googleapis.com', a2: '/oauth2/v1/userinfo'})
};
...
var $author$project$OAuth$Implicit$makeAuthorizationUrlWith = F3(
	function (responseType, extraFields, _v0) {
		...
		return A3(
			...
			responseType,
			extraFields,
			{N: clientId, av: redirectUri, S: scope, V: state, J: url});
	});
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{aL: false, aa: r.aa, ai: r.ai, ak: r.ak, an: r.an, aE: r.aE, aF: r.aF, J: r.J}));
};
		...
		return $elm$http$Http$request(
			{
				...
				ai: A2($elm$http$Http$expectJson, $author$project$Main$GotUserInfo, userInfoDecoder),
