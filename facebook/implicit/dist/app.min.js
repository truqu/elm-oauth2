...
{
	if (region.S.A === region.aa.A)
	{
		return 'on line ' + region.S.A;
	}
	return 'on lines ' + region.S.A + ' through ' + region.aa.A;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.aj, request.K, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {z: fragment, aT: host, a1: path, a2: port_, a3: protocol, G: query};
	});
...
var $author$project$OAuth$Implicit$parseTokenWith = F2(
	function (_v0, url_) {
		var tokenParser = _v0.be;
		var errorParser = _v0.aP;
		var authorizationSuccessParser = _v0.aK;
		var authorizationErrorParser = _v0.aJ;
		var url = _Utils_update(
			url_,
			{z: $elm$core$Maybe$Nothing, a1: '/', G: url_.z});
		var _v1 = A2(
			$elm$url$Url$Parser$parse,
			A2(
...
var $author$project$Internal$AuthorizationError = F4(
	function (error, errorDescription, errorUri, state) {
		return {ab: error, ac: errorDescription, ad: errorUri, T: state};
	});
...
var $author$project$OAuth$Implicit$AuthorizationSuccess = F5(
	function (token, refreshToken, expiresIn, scope, state) {
		return {aQ: expiresIn, a5: refreshToken, Q: scope, T: state, bd: token};
	});
...
var $author$project$Main$parsers = {aJ: $author$project$OAuth$Implicit$defaultAuthorizationErrorParser, aK: $author$project$OAuth$Implicit$defaultAuthorizationSuccessParser, aP: $author$project$Main$errorParser, be: $author$project$Main$tokenParser};
...
var $author$project$Main$init = F3(
	function (mflags, origin, navigationKey) {
		...
		switch (_v0.$) {
			case 0:
				return _Utils_Tuple2(
					{e: $author$project$Main$Idle, ar: redirectUri},
...
var $author$project$Main$UserInfo = F2(
	function (name, picture) {
		return {al: name, an: picture};
	});
var $author$project$Main$defaultHttpsUrl = {z: $elm$core$Maybe$Nothing, aT: '', a1: '', a2: $elm$core$Maybe$Nothing, a3: 1, G: $elm$core$Maybe$Nothing};
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$configuration = {
	L: _Utils_update(
		$author$project$Main$defaultHttpsUrl,
		{aT: 'facebook.com', a1: '/v6.0/dialog/oauth'}),
	M: '179456896198275',
	Q: _List_fromArray(
		['public_profile']),
	V: A3(
...
var $author$project$Internal$makeRedirectUri = function (url) {
	return $elm$core$String$concat(
		_List_fromArray(
			[
				$author$project$Internal$protocolToString(url.a3),
				'://',
				url.aT,
				A2(
				$elm$core$Maybe$withDefault,
...
var $author$project$OAuth$Implicit$makeAuthorizationUrlWith = F3(
	function (responseType, extraFields, _v0) {
		var clientId = _v0.M;
		var url = _v0.K;
		var redirectUri = _v0.ar;
		...
		return A3(
			...
			responseType,
			extraFields,
			{M: clientId, ar: redirectUri, Q: scope, T: state, K: url});
	});
var $author$project$OAuth$Implicit$makeAuthorizationUrl = A2($author$project$OAuth$Implicit$makeAuthorizationUrlWith, $author$project$OAuth$Token, $elm$core$Dict$empty);
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{aH: false, Y: r.Y, af: r.af, ag: r.ag, aj: r.aj, aA: r.aA, aB: r.aB, K: r.K}));
};
		...
		return $elm$http$Http$request(
			{
				...
				af: A2($elm$http$Http$expectJson, $author$project$Main$GotUserInfo, userInfoDecoder),
				ag: A2($author$project$OAuth$useToken, token, _List_Nil),
				aj: 'GET',
