...
{
	if (region.V.z === region.af.z)
	{
		return 'on line ' + region.V.z;
	}
	return 'on lines ' + region.V.z + ' through ' + region.af.z;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.ap, request.J, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {al: fragment, aX: host, a5: path, a6: port_, a7: protocol, F: query};
	});
...
var $author$project$Internal$AuthorizationError = F4(
	function (error, errorDescription, errorUri, state) {
		return {ag: error, ah: errorDescription, ai: errorUri, W: state};
	});
...
var $author$project$Main$init = F3(
	function (mflags, origin, navigationKey) {
		var redirectUri = _Utils_update(
			origin,
			{al: $elm$core$Maybe$Nothing, F: $elm$core$Maybe$Nothing});
		var clearUrl = A2(
		...
		switch (_v0.$) {
			case 0:
				return _Utils_Tuple2(
					{a: $author$project$Main$Idle, ax: redirectUri},
...
var $author$project$Main$UserInfo = F2(
	function (name, picture) {
		return {ar: name, at: picture};
	});
var $author$project$Main$defaultHttpsUrl = {al: $elm$core$Maybe$Nothing, aX: '', a5: '', a6: $elm$core$Maybe$Nothing, a7: 1, F: $elm$core$Maybe$Nothing};
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$configuration = {
	K: _Utils_update(
		$author$project$Main$defaultHttpsUrl,
		{aX: 'elm-oauth2.eu.auth0.com', a5: '/authorize'}),
	N: 'AbRrXEIRBPgkDrqR4RgdXuHoAd1mDetT',
	T: _List_fromArray(
		['openid', 'profile']),
	Y: _Utils_update(
		$author$project$Main$defaultHttpsUrl,
		{aX: 'elm-oauth2.eu.auth0.com', a5: '/oauth/token'}),
	Z: A3(
	...
	_: _Utils_update(
		$author$project$Main$defaultHttpsUrl,
		{aX: 'elm-oauth2.eu.auth0.com', a5: '/userinfo'})
};
...
var $author$project$Internal$AuthenticationSuccess = F4(
	function (token, refreshToken, expiresIn, scope) {
		return {aU: expiresIn, a9: refreshToken, T: scope, bh: token};
	});
...
var $author$project$OAuth$AuthorizationCode$defaultAuthenticationSuccessDecoder = $author$project$Internal$authenticationSuccessDecoder;
...
var $author$project$Internal$makeRedirectUri = function (url) {
	return $elm$core$String$concat(
		_List_fromArray(
			[
				$author$project$Internal$protocolToString(url.a7),
				'://',
				url.aX,
				A2(
				$elm$core$Maybe$withDefault,
...
var $author$project$Internal$makeRequest = F5(
	function (decoder, toMsg, url, headers, body) {
		return {
			...
			ak: A2($elm$http$Http$expectJson, toMsg, decoder),
			am: headers,
			ap: 'POST',
...
var $author$project$OAuth$AuthorizationCode$makeTokenRequestWith = F5(
	function (grantType, decoder, extraFields, toMsg, _v0) {
		var credentials = _v0.aR;
		var code = _v0.ad;
		var url = _v0.J;
		var redirectUri = _v0.ax;
		var headers = $author$project$Internal$makeHeaders(
			function () {
				var _v1 = credentials.bb;
				if (_v1.$ === 1) {
					return $elm$core$Maybe$Nothing;
				} else {
					var secret = _v1.a;
					return $elm$core$Maybe$Just(
						{N: credentials.N, bb: secret});
				}
			}());
		var body = A2(
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{aN: false, ab: r.ab, ak: r.ak, am: r.am, ap: r.ap, aG: r.aG, aH: r.aH, J: r.J}));
};
	...
	function (_v0, redirectUri, code) {
		...
		return $elm$http$Http$request(
			A2(
				...
				{
					ad: code,
					aR: {N: clientId, bb: $elm$core$Maybe$Nothing},
					ax: redirectUri,
					J: tokenEndpoint
				}));
	});
var $author$project$Main$accessTokenRequested = F2(
	function (model, code) {
		return _Utils_Tuple2(
			...
			A3($author$project$Main$getAccessToken, $author$project$Main$configuration, model.ax, code));
	});
...
var $author$project$Internal$AuthenticationError = F3(
	function (error, errorDescription, errorUri) {
		return {ag: error, ah: errorDescription, ai: errorUri};
	});
...
var $author$project$Main$gotAccessToken = F2(
	function (model, authenticationResponse) {
		if (authenticationResponse.$ === 1) {
			...
			var token = authenticationResponse.a.bh;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
...
var $author$project$OAuth$AuthorizationCode$makeAuthorizationUrlWith = F3(
	function (responseType, extraFields, _v0) {
		...
		return A3(
			...
			responseType,
			extraFields,
			{N: clientId, ax: redirectUri, T: scope, W: state, J: url});
	});
		...
		return $elm$http$Http$request(
			{
				...
				ak: A2($elm$http$Http$expectJson, $author$project$Main$GotUserInfo, userInfoDecoder),
				am: A2($author$project$OAuth$useToken, token, _List_Nil),
				ap: 'GET',
				aG: $elm$core$Maybe$Nothing,
				aH: $elm$core$Maybe$Nothing,
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		...
		a2: $elm$core$Basics$always($author$project$Main$NoOp),
