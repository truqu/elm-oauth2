...
{
	if (region.W.z === region.ag.z)
	{
		return 'on line ' + region.W.z;
	}
	return 'on lines ' + region.W.z + ' through ' + region.ag.z;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.aq, request.K, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {am: fragment, aZ: host, a7: path, a8: port_, a9: protocol, G: query};
	});
...
var $author$project$Internal$AuthorizationError = F4(
	function (error, errorDescription, errorUri, state) {
		return {ah: error, ai: errorDescription, aj: errorUri, X: state};
	});
...
var $author$project$OAuth$AuthorizationCode$PKCE$parseCodeWith = F2(
	function (parsers, url) {
		var _v0 = A2($author$project$OAuth$AuthorizationCode$parseCodeWith, parsers, url);
		switch (_v0.$) {
			case 0:
				return $author$project$OAuth$AuthorizationCode$PKCE$Empty;
			case 2:
				var s = _v0.a;
				return $author$project$OAuth$AuthorizationCode$PKCE$Success(s);
			default:
				var e = _v0.a;
				return $author$project$OAuth$AuthorizationCode$PKCE$Error(e);
		}
	});
...
var $author$project$Main$init = F3(
	function (mflags, origin, navigationKey) {
		var redirectUri = _Utils_update(
			origin,
			{am: $elm$core$Maybe$Nothing, G: $elm$core$Maybe$Nothing});
		var clearUrl = A2(
...
var $author$project$Main$defaultHttpsUrl = {am: $elm$core$Maybe$Nothing, aZ: '', a7: '', a8: $elm$core$Maybe$Nothing, a9: 1, G: $elm$core$Maybe$Nothing};
...
var $author$project$OAuth$AuthorizationCode = {$: 0};
...
var $author$project$OAuth$AuthorizationCode$PKCE$defaultAuthenticationSuccessDecoder = $author$project$Internal$authenticationSuccessDecoder;
...
var $author$project$Internal$urlAddExtraFields = F2(
...
var $author$project$OAuth$AuthorizationCode$makeTokenRequestWith = F5(
	function (grantType, decoder, extraFields, toMsg, _v0) {
		...
		var body = A2(
			...
			$elm$url$Url$Builder$toQuery(
				A2(
					$author$project$Internal$urlAddExtraFields,
					extraFields,
					_List_fromArray(
						[
							A2(
		...
		return A5($author$project$Internal$makeRequest, decoder, toMsg, url, headers, body);
	});
...
var $author$project$OAuth$AuthorizationCode$PKCE$makeTokenRequestWith = F5(
	function (grantType, decoder, extraFields, toMsg, _v0) {
		var credentials = _v0.aT;
		var code = _v0.ae;
		...
		return A5(
			$author$project$OAuth$AuthorizationCode$makeTokenRequestWith,
			grantType,
			decoder,
			A2($elm$core$Dict$union, extraFields, extraInternalFields),
			toMsg,
			{ae: code, aT: credentials, ay: redirectUri, K: url});
	});
var $author$project$OAuth$AuthorizationCode$PKCE$makeTokenRequest = A3($author$project$OAuth$AuthorizationCode$PKCE$makeTokenRequestWith, $author$project$OAuth$AuthorizationCode, $author$project$OAuth$AuthorizationCode$PKCE$defaultAuthenticationSuccessDecoder, $elm$core$Dict$empty);
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{aO: false, ac: r.ac, al: r.al, an: r.an, aq: r.aq, aH: r.aH, aI: r.aI, K: r.K}));
};
...
var $author$project$Main$accessTokenRequested = F3(
	function (model, code, codeVerifier) {
		return _Utils_Tuple2(
			...
			A4($author$project$Main$getAccessToken, $author$project$Main$configuration, model.ay, code, codeVerifier));
	});
...
var $author$project$OAuth$Code = {$: 0};
...
var $author$project$Internal$makeAuthorizationUrl = F3(
...
var $author$project$OAuth$AuthorizationCode$makeAuthorizationUrlWith = F3(
	function (responseType, extraFields, _v0) {
		var clientId = _v0.O;
		var url = _v0.K;
		var redirectUri = _v0.ay;
		...
		return A3(
			...
			responseType,
			extraFields,
			{O: clientId, ay: redirectUri, U: scope, X: state, K: url});
	});
var $author$project$OAuth$AuthorizationCode$PKCE$makeAuthorizationUrlWith = F3(
	function (responseType, extraFields, _v0) {
		var clientId = _v0.O;
		var url = _v0.K;
		var redirectUri = _v0.ay;
		...
		return A3(
			$author$project$OAuth$AuthorizationCode$makeAuthorizationUrlWith,
			responseType,
			A2($elm$core$Dict$union, extraFields, extraInternalFields),
			{O: clientId, ay: redirectUri, U: scope, X: state, K: url});
	});
var $author$project$OAuth$AuthorizationCode$PKCE$makeAuthorizationUrl = A2($author$project$OAuth$AuthorizationCode$PKCE$makeAuthorizationUrlWith, $author$project$OAuth$Code, $elm$core$Dict$empty);
	...
	function (model, bytes) {
		...
		if (_v0.$ === 1) {
			...
			var authorization = {
				...
				aS: $author$project$OAuth$AuthorizationCode$PKCE$mkCodeChallenge(codeVerifier),
				ay: model.ay,
